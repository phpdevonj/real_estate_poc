            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1">
                                        ...
                                        <a href="javascript:;" class="flex items-center mb-6">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#088178" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">000-000-000
                                            </h5>
                                        </a>
                                        ...
                                        <a href="javascript:;" class="flex items-center">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#088178" stroke-width="2" />
                                                <path
                                                    d="M17.5 11.6148C17.5 13.0531 16.3807 14.219 15 14.219C13.6193 14.219 12.5 13.0531 12.5 11.6148C12.5 10.1765 13.6193 9.01058 15 9.01058C16.3807 9.01058 17.5 10.1765 17.5 11.6148Z"
                                                    stroke="#088178" stroke-width="2" />
                                            </svg>
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">654
                                                demo, demotest, india jaipur</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        <h2 class="text-[#088178] font-manrope text-4xl font-semibold leading-10 mb-11">Send Us A
                            Message</h2>
                        <input type="text"
                            ...
                            <div class="flex">
                                <div class="flex items-center mr-11">
                                    ...
                                    <label for="radio-group-1" 
                                        class="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6 pl-6">
                                        Email
                                    </label>
                                </div>
                        ...
                        <input type="text"
                            ...
                            placeholder="Message">
                        <button
                            class="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 border border-gray-200 hover:bg-white hover:text-[#088178] bg-[#088178] shadow-sm">Send</button>
                    </div>
                </div>
            </div>    
        </section>
