...
$('.tabs li').click(function(){
    ...
    $('#' + tagid).addClass('hidden').removeClass('hidden');
    $('#' + tagid).find('.property-slider').slick('refresh');
});
...
$('.property-slider').slick({
    ...
    arrow: true,
    autoplay: true,
    prevArrow: '<div class="slick-prev prev"><i class="fa fa-angle-left" aria-hidden="true"></i></div>',
